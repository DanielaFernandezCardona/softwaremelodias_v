...
<div class="container" style="width:400px; "> 
    ...
    <table class="table table-hover" style="background-color:white;color:black; " >
     <thead>
      <tr>
       <th data-field="fecha" style="text-align: center;" data-align="right" >Titulo</th>
       <th data-field="fecha" style="text-align: center;" data-align="right" >Codigo Torneo</th>
       ...
       <th data-field="Premio" style="text-align: center;"> Acción</th>
